...
#define PD_VDM_USBPD_DISCOVER_SVIDS 2
#define PD_VDM_USBPD_DISCOVER_MODES 3
#define PD_VDM_USBPD_ENTER_MODE 4
#define PD_VDM_USBPD_EXIT_MODE 5
#define PD_VDM_USBPD_ATTENTION 6
#define PD_VDM_USBPD_DP_STATUS_UPDATE 0x10
#define PD_VDM_USBPD_DP_CONFIGURE 0x11
